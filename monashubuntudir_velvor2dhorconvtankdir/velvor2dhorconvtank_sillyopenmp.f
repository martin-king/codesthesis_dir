...
c     Program velvor2dperiodicrbconv.f                                 c
c======================================================================c
...
!mpkbug?     +      th(1,j,ka)) + 1./6.*(th(2,j,k)+th(2,j,ka)))*dri
     ...
     +      *dri
!mpkhc insulated -(-4./3.*(th(0,j,k)+th(0,j,ka)) +1.5d0*(th(1,j,k)+
!mpkhc insulated    +      th(1,j,ka)) - 1./6.*(th(2,j,k)+th(2,j,ka)))*dri
         elseif(i.eq.nr-1)then
...
!mpkhc wall with insulated b.c.
         if(i.eq.1)then
          tdmab(i)=1.d0
          tdmac(i)=2.d0
          tdmar(i)=dri*(-8d0*th(0,j,k)+6d0*th(1,j,k)+
     +             1.9d0*th(2,j,k)+0.1d0*th(4,j,k))
!mpkhc end
         elseif(i.eq.nr)then
          tdmaa(i)=2.d0
          tdmab(i)=1.d0
...
!mpkhc wall with insulated b.c.
         if(i.eq.1)then
          tdmab(i)=1.d0
          tdmac(i)=2.d0
          tdmar(i)=dri*(-8d0*th(0,j,k)+6.d0*th(1,j,k)+
     +             1.9d0*th(2,j,k)+0.1d0*th(4,j,k))
         elseif(i.eq.nr)then
          tdmaa(i)=2.d0
          tdmab(i)=1.d0
...
!mpk2d        trans1=trans1+trans*dp
        ka=k+1
        if(k.eq.np)ka=1
!c        trans1=trans1+0.5d0*dp*(-3.35238095d0*th(0,j,k)+
!c     +         4.375d0*th(1,j,k)-1.45833333d0*th(2,j,k)+
!c     +         0.525d0*th(3,j,k)-0.08928571d0*th(4,j,k))*dri+
!c     +         0.5d0*dp*(-3.35238095d0*th(0,j,ka)+
!c     +         4.375d0*th(1,j,ka)-1.45833333d0*th(2,j,ka)+
!c     +         0.525d0*th(3,j,ka)-0.08928571d0*th(4,j,ka))*dri
  ...
  10  continue
      ...
      do k=2,np-1
         ka=k+1
         trans1=trans1+0.5d0*dp*(-3.35238095d0*th(nr+1,j,k)+
     +         4.375d0*th(nr,j,k)-1.45833333d0*th(nr-1,j,k)+
     +         0.525d0*th(nr-2,j,k)-0.08928571d0*th(nr-3,j,k))*dri+
...
!         thn(0,j,k)=1.125d0*thn(1,j,k)-0.125d0*thn(2,j,k)
          thn(0,j,k)=-30.d0/92.d0*(-3.75d0*thn(1,j,k)+
     +        5.d0/6.d0*thn(2,j,k)-3.d0/20.d0*thn(3,j,k))
!mpkhc end
!mpktank        
!c          thn(nr+1,j,k)=dble(k)/dble(np+1)*1.d0
        if(k.le.np/2)then
          thn(nr+1,j,k)=30./92.*(3.75*thn(nr,j,k)-5./6.*thn(nr-1,j,k)+
     +              3./20.*thn(nr-2,j,k)-dr*8.63d0)
        else
          thn(nr+1,j,k)=30./92.*(3.75*thn(nr,j,k)-5./6.*thn(nr-1,j,k)+
     +              3./20.*thn(nr-2,j,k)+dr*8.63d0)
        endif
